import { render, screen, GROUP_ID, CHILD_ID_1, CHILD_ID_2, CHILD_ID_3, childArr } from './testUtils'
...
describe('Radio Group - Accessibility attributes', () => {
   describe('Parent', () => {
      test('Should have all default aria-attributes and if switching to read-only should not have such attrs anymore', () => {
         ...
         expect(group).toHaveAccessibleName('Rating Selection')
         ...
         expect(group).not.toHaveAccessibleName('Rating Selection')
